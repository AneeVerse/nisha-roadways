...
const LOCATIONS = [
  { name: 'New Mumbai', position: [19.033, 73.0297] },
  { name: 'Karnataka', position: [15.3173, 75.7139] },
  { name: 'Tamil Nadu', position: [11.1271, 78.6569] },
];
...
export default function GlobalLocationsMap() {
  ...
  if (!mounted || !geoData || !L) {
    return (
      <div className="w-full h-[585px] bg-white flex items-center justify-center font-poppins text-gray-400">
  ...
  return (
    <section className="font-poppins pt-[20px] pb-[60px] md:pt-[30px] md:pb-[80px] relative z-0">
